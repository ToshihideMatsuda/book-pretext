...
- `src/snake-animation.ts`: ダブルタップ時の蛇アニメーション
- `books/`: 表示対象のテキスト

## Snake Mode

- 本文エリアをダブルタップすると蛇モードに入ります。
- タイトル、作者名、本文、先頭の大きい一文字が順にほどけて泳ぎ始めます。
- 蛇モード中にもう一度ダブルタップすると、文字は元の位置に戻ります。
- 蛇モード中の通常タップで、餌を追うモードと鮫から逃げるモードが切り替わります。
